  ...
  return (
    <main className="mt-20 font-ti">
      ...
      <div className="">
          ...
          <span className="bg-white text-black inline text-[70px] font-bold my-2 ml-2 px-2 hover:-translate-y-1 hover:scale-110 hover:bg-black hover:text-white duration-300">05</span> 
        <div>
            <div className="grid grid-cols-5 grid-flow-col gap-4 justify-between pt-4">
                ...
                <div className="col-span-3">
                    <span className="bg-white text-black px-2 text-[20px] font-bold hover:-translate-y-1 hover:scale-110 hover:bg-black hover:text-white duration-300">FMG Management System</span>
            ...
            <div className="grid grid-cols-5 grid-flow-col gap-4 justify-between pt-4 mt-[100px]">
                <div className="col-span-3">
                    <span className="bg-white text-black px-2 text-[20px] font-bold hover:-translate-y-1 hover:scale-110 hover:bg-black hover:text-white duration-300">Uma Owner</span>
                    <p className="text-justify text-[18px] mt-2   ">
