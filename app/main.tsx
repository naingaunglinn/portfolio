...
const Main = () => {
    return(
        <div>
          ...
          <div className="mt-20">
            <Link href={'/contact'} className="text-[30px] bg-white text-black transition-colors duration-300 ease-in-out hover:bg-black hover:text-white hover:shadow-sm p-2">Contact Me!</Link>
          </div>
        </div>
    )
}
